...
function WireframeShape({ geometry, color = '#ffffff', rotationSpeed = 0.003 }: WireframeShapeProps) {
...
function GlassShape({ geometry, rotationSpeed = 0.003 }: { geometry: GeometryType, rotationSpeed?: number }) {
    const meshRef = useRef<THREE.Mesh>(null)
...
export function BentoWireframe({ geometry, className = '', accentColor = false, useGlass = false }: BentoWireframeProps) {
