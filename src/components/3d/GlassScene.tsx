...
import { useScroll, useTransform, useSpring, motion } from 'framer-motion' // Using framer-motion inside 3D via MotionCanvas if needed, or just standard hooks
...
function Particles({ isDark, scrollYProgress }: { isDark: boolean, scrollYProgress: any }) {
...
function Geometries({ isDark, scrollYProgress }: { isDark: boolean, scrollYProgress: any }) {
