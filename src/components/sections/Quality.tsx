  ...
  return (
    <section>
      <Container className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center py-32">
        <div>
          <h2 className="text-4xl md:text-6xl font-heading font-bold tracking-tighter leading-none mb-8">
            Obsession <br />
          ...
          <div className="space-y-8 text-lg text-muted-foreground">
            ...
            <p>
              Every pixel is debated. Every interaction is profiled. We treat
              code as a craft, not a commodity. The result is software that
              feels inevitable.
            </p>
          </div>
