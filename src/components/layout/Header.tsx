        ...
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4 pointer-events-none">
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
                    <a href="#manifesto" className="hover:text-foreground transition-colors">Vision</a>
                    <a href="#services" className="hover:text-foreground transition-colors">Services</a>
                    <a href="#process" className="hover:text-foreground transition-colors">Approach</a>
                </div>
