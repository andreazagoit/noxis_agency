  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden" id="home">
        ...
        <div className="flex justify-center relative z-10 py-52">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            <h2 className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-85">
              Sviluppo creativo di siti web e applicazioni
            </h2>
            <TextGenerateEffect
              className="text-center text-[40px] md:text-5xl lg:text-6xl"
              words={"Realizzazione siti web professionali"}
            />
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Il tuo partner di riferimento per Sviluppo e Design.
            </p>
            <a href="#contact">
              <MagicButton
                title="Contattaci"
